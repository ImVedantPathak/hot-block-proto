...
A lightweight, cross-platform C++ client for a fleet management system. Each client machine runs three cooperating programs that register with a central VPS, send periodic heartbeats, and execute commands issued by the server.
